    ...
    public class DepartamentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartamentsId,Name")] Departaments departaments)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (System.Exception ex)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Não é possivel salvar um departamento com o mesmo nome!!");
                    }
                    else
                    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Não foi possíve remover o departamento porque existe cidades relacionadas a ele, primeiro remova as cidades e volte a excluir!!");
                }
                else
                {
                    ModelState.AddModelError(string.Empty, ex.Message);
